    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return SwitchListTile(
          title: Text( chore.descriptione, style: const TextStyle(fontWeight: FontWeight.bold ) ), 
          //subtitle: Text(chore.completaIn.toString()),
          subtitle: Text(chore.completaIn != null 
          ? chore.completaIn.toString()
          : '¿Cuándo churri?'),
